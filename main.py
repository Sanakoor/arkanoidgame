...
pygame.display.set_caption("Neon Arkanoid")

# Colors, Fonts, Mute Setup
BG_COLOR = pygame.Color("#0f0f23")  # Dark Purple
BRICK_COLORS = [(255, 99, 71), (0, 255, 255), (144, 238, 144), (255, 105, 180)]  # Tomato, Cyan, LightGreen, HotPink
...
# Game Objects
paddle = Paddle(screen_width, screen_height, color=(0, 255, 255))  # Neon cyan
ball = Ball(screen_width, screen_height, color=(255, 255, 255))    # White
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                ...
                lasers.append(Laser(paddle.rect.centerx - 30, paddle.rect.top, color=(255, 0, 0)))  # Red laser
                lasers.append(Laser(paddle.rect.centerx + 30, paddle.rect.top, color=(255, 0, 0)))
                laser_sound.play()

    screen.fill(BG_COLOR)

    if game_state == 'title_screen':
        screen.blit(title_font.render("NEON ARKANOID", True, (255,255,255)), (screen_width//2 - 200, screen_height//2 - 80))
